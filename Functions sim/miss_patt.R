...
# missingness pattern nr. 1: 7 covariates are missing
# missingness pattern nr. 2: 6 covariates are missing
# missingness pattern nr. 3: 5 covariates are missing
# missingness pattern nr. 4: 4 covariates are missing
# missingness pattern nr. 5: 3 covariates are missing
...
miss_patt <- function(n_param){
  ...
  #rowSums(pattern_MAR) # random assignment worked: the correct number of missing covariates is present per pattern
